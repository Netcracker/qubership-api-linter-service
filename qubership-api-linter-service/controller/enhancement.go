...
type EnhancementController interface {
	...
	UpdateEnhancedDoc(w http.ResponseWriter, r *http.Request)
...
func (e enhancementControllerImpl) UpdateEnhancedDoc(w http.ResponseWriter, r *http.Request) {
	packageId := getStringParam(r, "packageId")
	...
	err = e.enhancementService.UpdateEnhancedDoc(ctx, packageId, versionName, slug, string(body))
	if err != nil {
		respondWithError(w, "Failed to get enhanced document", err)
		return
	}
